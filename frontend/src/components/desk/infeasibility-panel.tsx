  ...
  return (
    <div className="mx-auto max-w-2xl rounded border border-risk bg-surface">
      <div className="flex items-center gap-2 border-b border-risk bg-risk-soft px-3 py-2">
        ...
        <span className="text-[12px] font-bold uppercase tracking-wide text-risk">
      ...
      <ul className="divide-y divide-border">
        {problems.map((p, i) => (
          <li key={i} className="px-3 py-2.5">
            ...
            <p className="mt-0.5 text-[13px] text-foreground">{p.message}</p>
            <div className="mt-1.5 grid grid-cols-2 gap-2">
              <div className="rounded bg-surface-2 px-2 py-1">
                <div className="text-[9px] font-semibold uppercase tracking-wide text-muted-foreground">
                  You asked for
                </div>
                <div className="desk-num text-[11px]">{p.observed}</div>
              </div>
              <div className="rounded bg-surface-2 px-2 py-1">
                <div className="text-[9px] font-semibold uppercase tracking-wide text-muted-foreground">
                  Feasible limit
                </div>
                <div className="desk-num text-[11px]">{p.limit}</div>
              </div>
            </div>
          </li>
        ))}
